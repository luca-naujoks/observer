...
describe('PosterMediaCard', () => {
    const mockMedia: IMedia = {
        ...
        poster: 'https://github.com/luca-naujoks/observer/blob/development/public/icon.png',
        backdrop: 'https://github.com/luca-naujoks/observer/blob/development/public/overview.png',
        name: 'Test Media',
        type: 'anime',
    ...
    it('falls back to missing poster image on error', () => {
        ...
        expect(image).toHaveAttribute('src', 'http://localhost/missing-poster.webp')
    })
    ...
    it('renders a link with the correct href', () => {
        ...
        const linkElement = screen.getByRole('link')
        expect(linkElement).toHaveAttribute('href', `/media?stream_name=${mockMedia.stream_name}`)
    })
})